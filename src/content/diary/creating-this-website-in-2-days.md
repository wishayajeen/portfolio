...
![Claude Design system creation UI showing semantic color tokens and system setup](../../assets/diary/claude-design-system.png)

And then it gave me a first draft of the site:

![First draft landing page generated by Claude Design with hero, cards, and layout](../../assets/diary/claude-first-draft.png)
...
Here I used [Vercel](https://vercel.com/) because:
- it has a free tier
